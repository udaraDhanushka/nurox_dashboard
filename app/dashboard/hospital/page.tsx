  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      ...
      setStats({
        ...
        systemAlerts: 2,
        recentActivity: [
          { id: 1, action: 'New doctor verification request', user: 'Dr. Sarah Chen', timestamp: '5 minutes ago' },
          { id: 2, action: 'Appointment scheduled', user: 'Dr. Michael Thompson', timestamp: '15 minutes ago' },
          { id: 3, action: 'Staff member updated profile', user: 'Nurse Jessica Wilson', timestamp: '1 hour ago' },
        ]
      });
