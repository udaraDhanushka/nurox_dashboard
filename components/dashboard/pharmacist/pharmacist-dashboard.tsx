    ...
    <div className="flex flex-col space-y-6 p-6">
      ...
      <Tabs defaultValue="overview" className="space-y-6" onValueChange={setSelectedTab}>
                  ...
                  {[
                    ...
                    <div key={index} className="flex items-center gap-4 p-3 rounded-md border">
                      <div className={cn(
                        ...
                        prescription.urgency === "high" ? "bg-red-500" :
                        prescription.urgency === "medium" ? "bg-yellow-500" : "bg-green-500"
                      )}></div>
                      <div className="flex-grow">
                        <div className="flex items-center justify-between mb-1">
                          <p className="font-medium">{prescription.patient}</p>
                          <Badge 
                            variant={prescription.urgency === "high" ? "destructive" : 
                                    prescription.urgency === "medium" ? "default" : "outline"}
                            className="text-[10px] h-5"
                          >
                            {prescription.urgency === "high" ? "Urgent" : 
                             prescription.urgency === "medium" ? "Standard" : "Routine"}
                          </Badge>
                        </div>
                    ...
                    <div key={index} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge 
                          variant={item.status === "critical" ? "destructive" : 
                                  item.status === "low" ? "default" : "outline"}
                          className="text-[10px] h-5"
                        >
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center justify-between text-xs">
                          ...
                          <span>{item.min} min / {item.max} max</span>
                        </div>
        ...
        <TabsContent value="prescriptions">
          <Card className="p-6">
            <p className="text-center py-8">Prescriptions management interface would be shown here.</p>
          </Card>
        </TabsContent>
