        ...
        <TabsContent value="overview" className="space-y-6">
                  ...
                  {[
                    ...
                    <div key={index} className="flex items-center gap-4">
                      ...
                      <Button
                        ...
                        size="sm"
                        className={
                          appointment.status === 'completed' ? 'pointer-events-none opacity-50' : ''
                        }
                      >
                        {appointment.status === 'completed'
                          ? 'Completed'
          ...
          <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
            ...
            <Card>
                    ...
                    >
                      <div className="flex-grow">
                        ...
                        <p className="text-sm">
                          ...
                          <span
                            className={
                              result.status === 'abnormal' ? 'text-red-600 font-medium' : ''
                            }
                          >
                            {result.result}
                          </span>
              ...
              <CardFooter>
                <Button variant="outline" className="w-full" asChild>
                  <Link href="/dashboard/doctor/lab-tests">View All Results</Link>
                </Button>
              </CardFooter>
            </Card>
          </div>
