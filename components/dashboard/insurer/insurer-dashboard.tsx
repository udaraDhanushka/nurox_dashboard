          ...
          <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                ...
                <Button variant="outline" size="sm" asChild>
                  <Link href="/dashboard/insurer/claims">
                    View all
                  </Link>
                </Button>
              </CardHeader>
                  ...
                  {[
                    ...
                    <div key={index} className="flex items-center gap-4 p-3 rounded-md border">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-sm">{claim.provider}: {claim.service}</p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monthly overview of claims and processing efficiency</CardDescription>
              </CardHeader>
          ...
          <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                ...
                <Button variant="outline" size="sm" asChild>
                  <Link href="/dashboard/insurer/members">
                    View all
                  </Link>
                </Button>
              </CardHeader>
                    ...
                    <div key={index} className="flex items-center gap-4">
                      {activity.avatar ? (
                        <Avatar className="h-10 w-10">
                          <AvatarImage src={`https://ui-avatars.com/api/?name=${encodeURIComponent(activity.member)}&background=random`} />
                          <AvatarFallback>{activity.member.split(' ').map(n => n[0]).join('')}</AvatarFallback>
                        </Avatar>
                      ) : (
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-sm">{activity.activity}: {activity.details}</p>
                  ...
                  {[
                    ...
                    <div key={index} className="p-3 rounded-md border">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <Badge 
                          variant={
                            policy.status === "expiring-soon" ? "destructive" : 
                            policy.status === "pending-review" ? "default" : "outline"
                          }
                          className="text-[10px] h-5"
                        >
                          {policy.status === "expiring-soon" ? "Expiring Soon" : 
                           policy.status === "pending-review" ? "Needs Review" : "Renewal Ready"}
                        </Badge>
                      </div>
                      ...
                      <div className="mt-2 flex items-center text-xs">
                        <span className="text-muted-foreground">{policy.daysLeft} days remaining</span>
