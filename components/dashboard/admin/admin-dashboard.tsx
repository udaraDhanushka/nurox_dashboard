                    ...
                    <div key={index} className="flex items-center justify-between p-3 rounded-md border">
                      <div className="flex items-center gap-3">
                        <div className={cn(
                          ...
                          service.status === "partial_outage" ? "bg-yellow-500" : "bg-red-500"
                        )}></div>
                        <div>
                  ...
                  {[
                    ...
                    <div key={index} className="flex items-start gap-3 pb-3 border-b last:border-0">
                      <div className={cn(
                        ...
                        log.level === "warning" ? "bg-yellow-100" : "bg-red-100"
                      )}>
                        {log.level === "info" ? (
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Badge 
                            variant={
                              ...
                              log.level === "warning" ? "default" : "destructive"
                            }
                  ...
                  <div className="pt-2 space-y-3">
                    ...
                    {[
                      ...
                      <div key={index} className={cn(
                        ...
                        alert.status === "unresolved" ? "bg-red-50 border-red-200" :
                        alert.status === "under_review" ? "bg-yellow-50 border-yellow-200" : 
                        ...
                        <div className="flex items-center justify-between mb-1">
                          <div className="flex items-center gap-2">
                            ...
                            <Badge 
                              variant={
                                ...
                                alert.level === "medium" ? "default" : "outline"
                              }
                              className="text-[10px] h-5"
                            >
                          ...
                          <Badge 
                            variant={
                              alert.status === "unresolved" ? "destructive" :
                              alert.status === "under_review" ? "default" : "outline"
                            }
                            className="text-[10px] h-5"
                          >
                            {alert.status === "unresolved" ? "Unresolved" :
                             alert.status === "under_review" ? "Reviewing" : "Resolved"}
                          </Badge>
                        </div>
