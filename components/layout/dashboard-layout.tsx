...
const roleNavItems: Record<string, NavItem[]> = {
  ...
  lab: [
    ...
    {
      title: 'Test Orders',
      href: '/dashboard/lab/test-orders',
      icon: <FileText className="w-5 h-5" />,
    },
    {
      title: 'Test Types',
      href: '/dashboard/lab/test-types',
      icon: <Beaker className="w-5 h-5" />,
    },
  ],
  insurer: [
...
export default function DeprecatedDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`min-h-screen bg-gray-100 hydration-safe ${isHydrated ? 'hydrated' : ''}`}>
      ...
      {/* Main Content */}
      <div className={cn('transition-all', isSidebarOpen ? 'lg:ml-64' : '')}>
        {/* Header */}
